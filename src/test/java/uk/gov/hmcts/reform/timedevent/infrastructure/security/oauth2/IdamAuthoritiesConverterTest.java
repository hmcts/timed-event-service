...
class IdamAuthoritiesConverterTest {
    ...
    @Mock
    private IdamUserInfo idamUserInfo;
    ...
    public void should_return_correct_granted_authority_collection() {
        ...
        when(idamUserInfo.getRoles()).thenReturn(Lists.newArrayList("caseworker-ia", "caseworker-ia-caseofficer"));
        when(idamApi.userInfo("Bearer " + tokenValue)).thenReturn(idamUserInfo);
    ...
    public void should_return_empty_list_when_user_info_does_not_contain_roles() {
        ...
        when(idamUserInfo.getRoles()).thenReturn(Lists.newArrayList());
        when(idamApi.userInfo("Bearer " + tokenValue)).thenReturn(idamUserInfo);
