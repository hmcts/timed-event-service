...
class TestingSupportControllerTest {
    ...
    void should_return_token_from_generator() {
        ...
        TestingSupportController testingSupportController = new TestingSupportController(systemTokenGenerator, systemUserProvider, eventExecutor);
    ...
    void should_execute_event() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals("event: " + event + ", executed for id: " + caseId, response.getBody());
    }

    @Test
    void should_throw_exception_if_executor_failed() {
        ...
        doThrow(FeignException.class).when(eventExecutor).execute(jurisdiction, caseType, event, caseId);
